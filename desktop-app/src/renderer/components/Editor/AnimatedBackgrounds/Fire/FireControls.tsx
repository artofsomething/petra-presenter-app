...
const FireControls: React.FC<FireControlsProps> = ({ current, onChange }) => {
  ...
  return (
    <div style={{
      ...
      <ColorRow label="Fire 1" value={c1} onChange={(v) => onChange({ color1: v })} />
      <ColorRow label="Fire 2" value={c2} onChange={(v) => onChange({ color2: v })} />
      <ColorRow label="Fire 3" value={c3} onChange={(v) => onChange({ color3: v })} />
