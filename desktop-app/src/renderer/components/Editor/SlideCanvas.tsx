...
//   // ======================================================
//   // BUG 6 FIX: Clear selection and transformer on slide change
//   // ======================================================
//   useEffect(() => {
...
//     if (selectedElementId && !editingText) {
//       // Make sure the selected element exists in the CURRENT slide
//       const elementExists = currentSlide?.elements.some(
//         (el) => el.id === selectedElementId
//       );
...
//         }
//       } else {
//         // Element doesn't exist on this slide - clear selection
//         transformerRef.current.nodes([]);
//         setSelectedElementId(null);
//       }
//     } else {
...
//   const handleTransformEnd = useCallback(
//     (e: Konva.KonvaEventObject<Event>, elementId: string) => {
//       if (!editable) return;
//       const node = e.target;
//       const scaleX = node.scaleX();
//       const scaleY = node.scaleY();
...
//         }
//       }
//       // Layer shortcuts (Ctrl/Cmd + bracket keys)
//       if ((e.ctrlKey || e.metaKey) && selectedElementId) {
//         switch (e.key) {
//           case ']':
//             e.preventDefault();
...
//   // ======================================================
//   // BUG 7 FIX: Circle uses Rect wrapper for consistent positioning
//   // ======================================================
//   const renderShape = (element: SlideElement) => {
//     const x = element.x * SCALE;
//     const y = element.y * SCALE;
...
//             {/* Invisible rect for consistent transform/drag bounds */}
...
//             onClick={(e) => handleElementSelect(e, element.id)}
//             onDragEnd={(e) => element.isLocked?undefined:handleDragEnd(e, element.id)}
...
//       }}
//     >
//       {/* Video Background (HTML layer behind canvas) */}
//       {hasVideoBackground && (
//         <VideoBackground
//           videoSrc={currentSlide.backgroundVideo!}
//           loop={currentSlide.backgroundVideoLoop ?? true}
...
//         onClick={handleStageClick}
//         style={{
//           position: hasVideoBackground ? 'relative' : 'static',
//           zIndex: 1,
//           borderRadius: 6,
//         }}
//       >
//         <Layer>
//           {/* Solid color background (hidden if video bg) */}
//           <Rect
//             id="slide-bg"
//             x={0} y={0}
//             width={CANVAS_WIDTH} height={CANVAS_HEIGHT}
//             fill={hasVideoBackground ? 'transparent' : (currentSlide.backgroundColor || '#ffffff')}
//           />

//           {/* Background Image (rendered inside Konva) */}
